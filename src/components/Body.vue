...
<button type="button" class="btn btn-primary cd-container-read-more" data-toggle="modal" data-target="#exampleModalLong1">
  Read More
</button>
...
<button type="button" class="btn btn-primary cd-container-read-more"data-toggle="modal" data-target="#exampleModalLong2">
Read More
</button>
...
<div v-for="item in modalMap">
  <modal-helper :id="item.id" :pdf="item.pdf">
    ...
    <div slot="body" v-html="item.body"></div>
