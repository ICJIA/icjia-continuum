module.exports = {
  meta: [
    ...
    { property: "og:image", content: "http://www.icjia.state.il.us/assets/img/icjia-default.jpg" },
  ],
  script: [
  ...
  link: [
    ...
    {rel: "icon", type: "image/png", sizes: "96x96",  href: '/static/icons/favicon-96x96.png?v=1440170181'},
